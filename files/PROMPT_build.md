...
999999999. Keep @IMPLEMENTATION_PLAN.md current with learnings. Update especially after finishing your turn.
...
99999999999999. If you find inconsistencies in the content then do deep analysis ("ultrathink") to update the specs/pages.
